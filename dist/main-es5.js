(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
            ...
            var SearchComponent = /** @class */ (function () {
                function SearchComponent() {
                    ...
                    this.search.valueChanges
                        ...
                        .subscribe(function (value) { return _this.searchEmmiter.emit(value); });
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StudentCreateComponent = /** @class */ (function () {
                function StudentCreateComponent(fb, router, ngZone, apiService) {
                    this.fb = fb;
                    this.router = router;
                    this.ngZone = ngZone;
                ...
                StudentCreateComponent.prototype.mainForm = function () {
                ...
                StudentCreateComponent.prototype.updateProfile = function (e) {
                    this.studentForm.get('majorIn').setValue(e, {
                        onlySelf: true
                    });
                };
                StudentCreateComponent.prototype.updateSexList = function (e) {
                    this.studentForm.get('sex').setValue(e, {
                        onlySelf: true
                    });
                };
                Object.defineProperty(StudentCreateComponent.prototype, "myForm", {
                ...
                StudentCreateComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    if (!this.studentForm.valid) {
                        ...
                        this.apiService.createStudent(this.studentForm.value).subscribe(function (res) {
                            console.log('student successfully created!');
                            _this.ngZone.run(function () { return _this.router.navigateByUrl('/student-list'); });
                        }, function (error) {
                            console.log(error);
                        });
                    }
            ...
            StudentCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StudentEditComponent = /** @class */ (function () {
                function StudentEditComponent(fb, actRoute, apiService, router) {
                    this.fb = fb;
                ...
                StudentEditComponent.prototype.updateProfile = function (e) {
                    this.editForm.get('majorIn').setValue(e, {
                        onlySelf: true
                    });
                };
                StudentEditComponent.prototype.updateSexList = function (e) {
                    this.editForm.get('sex').setValue(e, {
                        onlySelf: true
                    });
                };
                Object.defineProperty(StudentEditComponent.prototype, "myForm", {
                    // Getter to access form control
                    get: function () {
                ...
                StudentEditComponent.prototype.getStudent = function (id) {
                    var _this = this;
                    this.apiService.getStudent(id).subscribe(function (data) {
                    ...
                    if (!this.editForm.valid) {
                        ...
                        if (window.confirm('Are you sure?')) {
                            ...
                            this.apiService.updateStudent(id, this.editForm.value)
                                ...
                                _this.router.navigateByUrl('/student-list');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StudentListComponent = /** @class */ (function () {
                function StudentListComponent(apiService) {
                    this.apiService = apiService;
                    this.Student = [];
                ...
                StudentListComponent.prototype.readStudent = function () {
                    var _this = this;
                    this.apiService.getStudents({}).subscribe(function (data) {
                        _this.Student = data;
                    });
                };
                StudentListComponent.prototype.removeStudent = function (student, index) {
                    var _this = this;
                    if (window.confirm('Are you sure?')) {
                        this.apiService.deleteStudent(student._id).subscribe(function (data) {
                            _this.Student.splice(index, 1);
                        });
                    }
                };
                StudentListComponent.prototype.handleSearch = function (value) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchPipe = /** @class */ (function () {
                ...
                SearchPipe.prototype.transform = function (list, text) {
                    if (!text) {
                        return list;
                    }
                    return list.filter(function (student) { return student.name
                        .toUpperCase()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApiService = /** @class */ (function () {
                ...
                // pagination
                ApiService.prototype.paginate = function (page) {
                    var url = this.baseUri + "/pages/" + page;
